...
export default function Checkout({ program, amount, paymentMethods }) {
    ...
    function submit(e) {
        e.preventDefault();
        post(route("program-donations.store", program.id));
    }
    ...
    return (
        <>
            <Head title={`Checkout · ${program.title_program}`} />
                        ...
                        <div className="sm:sticky sm:top-8 space-y-6">
                            <div className="rounded-[24px] donation-card-shadow bg-white p-8">
                                ...
                                <button
                                    ...
                                    form="checkout-form"
                                    disabled={processing}
                                    className="mt-6 flex h-14 w-full items-center justify-center gap-3 rounded-2xl bg-primary text-lg font-semibold text-white shadow-lg transition hover:shadow-xl disabled:opacity-60 cursor-pointer"
                                >
                                    {processing
                                        ? "Processing..."
                                        : "Donate Now"}
                    ...
                    <div className="sm:order-1 sm:col-span-3">
                        ...
                        <div className="mt-6 space-y-6 rounded-[24px] donation-card-shadow bg-white p-8">
                            <div className="flex items-center gap-3">
                                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-amber-800/10 text-amber-800">
                                    <Wallet size={20} />
                                </div>
                            ...
                            <div className="flex items-center gap-2 border-t border-stone-100 pt-4 text-xs text-stone-400">
                                <ShieldCheck size={16} />
                                Transaksi diproses aman lewat Doitpay.
                            </div>
                        </div>
                    </div>
                </div>
